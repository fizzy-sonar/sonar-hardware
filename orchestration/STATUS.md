...
_Last updated: 2026-08-26 by codex/sol-t011 — T-011 digital sheet + authoritative pinmap delivered; awaiting second-agent pin audit._
...
- **T-011 delivered (pending audit):** `orchestration/pinmap.md` (authoritative pin
  table, generated by `scripts/gen_digital_sheet.py`), `digital.kicad_sch` (DIP-48
  Cmod socket, FT232H header, GND-interleaved PDM/Pico header, DNP RMII block, TX
  labels, TPs), `gateware/constraints/sonar_cmod_a7.xdc`; DF40 + adc_bus removed from
  the top sheet. Digital sheet ERC-clean; PDM_CLK_FB on clock-capable pio36. Remaining:
  second-agent pinmap audit vs live Digilent docs, then T-011 done.
...
| T-011 digital sheet | **top** | sheet+pinmap+XDC delivered; **needs audit session** (network) then done |
