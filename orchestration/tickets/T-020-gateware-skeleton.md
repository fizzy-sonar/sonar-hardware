...
1. PDM clock generation (rate per T-008 contract) + 12-line IDDR sampler
   (or 24-line SDR if T-008 picks unpaired).
...
packer + FIFO against synthetic PDM; batch bitstream build succeeds on the Vivado
host; UART snapshot mode demonstrated in sim.
